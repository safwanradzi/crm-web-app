...
export function GoogleAdsHero() {
    return (
        <section className="relative pt-32 pb-12 md:pt-32 md:pb-20 overflow-hidden bg-gradient-to-br from-brand-midnight via-brand-midnight to-brand-indigo">
            ...
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600/20 rounded-full blur-3xl opacity-20 animate-pulse"></div>
            ...
            <div className="container relative mx-auto px-4 max-w-6xl z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left relative z-20">
                        ...
                        >
                            Google Ads Management That <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Captures</span> High-Intent Buyers
                        </motion.h1>
                        ...
                        >
                            We plan, launch, and optimize Google Ads campaigns designed to attract customers who are actively searching for your products or services.
                        </motion.p>
                        ...
                        >
                            <div className="text-center p-8 relative">
                                ...
                                <motion.div
                                    ...
                                    className="absolute -top-12 -left-12 bg-green-500/20 backdrop-blur-sm border border-green-500/30 p-3 rounded-lg flex items-center gap-2"
                                >
                                    <TrendingUp className="w-5 h-5 text-green-400" />
                                    <span className="text-green-400 font-bold text-sm">+450% ROAS</span>
                                </motion.div>

                                <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform duration-500">
                                    <MousePointerClick className="w-10 h-10 text-white" />
                                </div>
                                <h3 className="text-xl font-bold text-white mb-2">Precision Targeting</h3>
                                <p className="text-indigo-200 text-sm">Keyword Intent • conversion Optimization</p>
                            </div>

                            {/* Decorative Elements */}
                            <div className="absolute -top-10 -right-10 w-40 h-40 bg-blue-500/20 rounded-full blur-2xl"></div>
                            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-indigo-500/40 rounded-full blur-2xl"></div>
                        </motion.div>
                    </div>
                </div>
            </div>
