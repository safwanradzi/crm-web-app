...
export function GoogleAdsHero() {
    const t = useTranslations('GoogleAds.hero')
            ...
            <div className="container relative mx-auto px-4 max-w-6xl z-10">
                <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-16 items-center">
                    ...
                    <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left relative z-20">
                        ...
                        >
                            {t('prefix')}<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">{t('highlight')}</span>{t('suffix')}
                        </motion.h1>
                        ...
                        >
                            <Button asChild size="lg" className="w-full sm:w-auto h-14 px-8 text-lg bg-white text-brand-midnight hover:bg-slate-50 shadow-lg shadow-blue-900/20 rounded-full transition-all hover:scale-[1.02] border-0">
                    ...
                    <div className="relative hidden lg:block">
                        ...
                        >
                            <img 
                                src="/googleads.png"
                                alt="Google Ads Management Visual"
