...
export function WebsiteHero() {
    const t = useTranslations('WebDev.hero')
            ...
            <div className="container relative mx-auto px-4 max-w-6xl z-10">
                <div className="grid lg:grid-cols-[1fr_1.1fr] gap-8 lg:gap-12 items-center">
                    ...
                    <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
                        ...
                        >
                            {t('prefix')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-coral to-orange-400">{t('highlight')}</span>{t('suffix')}
                        </motion.h1>
